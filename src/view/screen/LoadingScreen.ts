...
export default class LoadingScreen extends BaseScreen {
    ...
    private loadAssets(): void {
        ...
        this.loadStandaloneImage('tasksPanelBgTop', 'assets/base/task/bg_top.png');
        this.loadStandaloneImage('tasksPanelBgCenter', 'assets/base/task/bg_center.png');
        this.loadStandaloneImage('tasksPanelBgBottom', 'assets/base/task/bg_bottom.png');
        this.loadStandaloneImage('tasksPanelHeaderRibbon', 'assets/base/task/header_ribbon.png');
        this.loadStandaloneImage('tasksPanelTabActive', 'assets/base/task/tab_active.png');
        this.loadStandaloneImage('tasksPanelTabInactive', 'assets/base/task/tab_inactive.png');
        this.loadStandaloneImage('tasksPanelListTop', 'assets/base/task/taks_list_bg_top.png');
        this.loadStandaloneImage('tasksPanelListCenter', 'assets/base/task/taks_list_bg_center.png');
        this.loadStandaloneImage('tasksPanelListBottom', 'assets/base/task/taks_list_bg_bottom.png');
        this.loadStandaloneImage('tasksPanelProgressEmpty', 'assets/base/task/progress_empty.png');
        this.loadStandaloneImage('tasksPanelProgressFull', 'assets/base/task/progress_full.png');
        this.loadStandaloneImage('tasksPanelChest', 'assets/base/task/chest.png');
        this.loadStandaloneImage('tasksPanelTaskBg', 'assets/base/task/task_bg.png');
        this.loadStandaloneImage('tasksPanelTaskItemBg', 'assets/base/task/task_item_bg.png');
        this.loadStandaloneImage('tasksPanelTaskRewardBg', 'assets/base/task/task_reward_bg.png');
        this.loadStandaloneImage('tasksPanelTaskProgressEmpty', 'assets/base/task/task_progress_empty.png');
        this.loadStandaloneImage('tasksPanelTaskProgressFull', 'assets/base/task/task_progress_full.png');

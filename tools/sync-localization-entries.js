...
const manualKeys = [
    ...
    'ui.character.currentValue',
    'ui.character.upgradeCost',
    'ui.character.effectPerLevel',
    'ui.character.noArtifact',
    'ui.character.artifactSlot',
    'ui.character.levelShort',
    'ui.character.slot.helmet',
    'ui.character.slot.weapon',
    'ui.character.slot.boots',
    'ui.character.slot.amulet',
    'ui.character.slot.armor',
    'ui.character.slot.ring',
    'ui.character.takeOff',
    'ui.character.wear',
    'ui.character.replace',
    'ui.character.wearSelectTitle',
    'ui.character.wearSelectText',
    'ui.character.noWearTargets',
    'ui.character.maxLevel',
    'ui.character.name.sveta',
    'ui.character.name.boris',
    'ui.character.name.kitten',
    'ui.character.name.owl',
    'ui.character.name.leshy',
...
const textKeys = [
    ...
    'text.supportMessage',
    'text.purchaseReward',
    'text.purchaseRewardBackpack',
    'text.purchaseRewardEquipped',
